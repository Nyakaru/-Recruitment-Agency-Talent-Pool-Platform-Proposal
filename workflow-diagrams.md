...
1. **GitHub/GitLab**: These diagrams will render automatically when viewing this markdown file
2. **VS Code**: Install the "Markdown Preview Mermaid Support" extension
3. **Online**: Copy and paste into [Mermaid Live Editor](https://mermaid.live/)
4. **Documentation**: Export as SVG/PNG for inclusion in presentations

### Diagram Legend

- **Green nodes**: Success states, completion points
- **Pink/Red nodes**: Error states, failures, cancellations
- **Light green nodes**: Start points
- **Diamond shapes**: Decision points
- **Rectangles**: Process steps
- **Rounded rectangles**: External actions or endpoints

### Customization

These diagrams can be customized by:
- Changing colors in the `style` declarations
- Adding more decision points as features evolve
- Splitting complex flows into sub-diagrams
- Adding swim lanes for multi-actor processes
